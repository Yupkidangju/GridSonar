...
const translations = {
    ko: {
        ...
        metaSimilarity: '_유사도',
        exportFileName: '검색결과',
        errUnsupportedFormatCount: '⚠️ {count}개 파일이 지원되지 않는 형식입니다 (.xlsx, .xls, .csv만 가능)',
        errUnsupportedFormat: '⚠️ 지원되지 않는 파일 형식입니다 (.xlsx, .xls, .csv만 가능)',
    ...
    en: {
        ...
        errUnsupportedFormatCount: '⚠️ {count} files have unsupported formats (only .xlsx, .xls, .csv supported)',
        errUnsupportedFormat: '⚠️ Unsupported file format (only .xlsx, .xls, .csv supported)',
    ...
    ja: {
        ...
        metaSimilarity: '_類似度',
        exportFileName: '検索結果',
        errUnsupportedFormatCount: '⚠️ {count}個のファイルは未対応形式です (.xlsx, .xls, .csvのみ対応)',
        errUnsupportedFormat: '⚠️ 未対応のファイル形式です (.xlsx, .xls, .csvのみ対応)',
    ...
    'zh-TW': {
        ...
        metaSimilarity: '_相似度',
        exportFileName: '搜尋結果',
        errUnsupportedFormatCount: '⚠️ {count} 個檔案格式不支援 (僅支援 .xlsx, .xls, .csv)',
        errUnsupportedFormat: '⚠️ 檔案格式不支援 (僅支援 .xlsx, .xls, .csv)',
    ...
    'zh-CN': {
        ...
        metaSimilarity: '_相似度',
        exportFileName: '搜索结果',
        errUnsupportedFormatCount: '⚠️ {count} 个文件格式不支持 (仅支持 .xlsx, .xls, .csv)',
        errUnsupportedFormat: '⚠️ 文件格式不支持 (仅支持 .xlsx, .xls, .csv)',
